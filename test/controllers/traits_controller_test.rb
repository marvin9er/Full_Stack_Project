...
class TraitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trait" do
    assert_difference('Trait.count') do
      post traits_url, params: { trait: { desc: @trait.desc, index: @trait.index, name: @trait.name, races: @trait.races, subraces: @trait.subraces, url: @trait.url } }
    end
  ...
  test "should update trait" do
    patch trait_url(@trait), params: { trait: { desc: @trait.desc, index: @trait.index, name: @trait.name, races: @trait.races, subraces: @trait.subraces, url: @trait.url } }
